	...
	return {
		...
		character: {
			...
			xin_huojun: [
				...
				4,
				["sidai", "jieyu"],
				["character:tw_huojun", "die_audio:tw_huojun"],
			],
			...
			jiangji: [
				...
				3,
				["twjichou", "jilun"],
				["character:tw_jiangji", "die_audio:tw_jiangji"],
			],
		...
		characterIntro: {
			lizhaojiaobo:
				"李昭（？—约公元260年），三国时期曹魏官吏，官拜冗从仆射，为魏帝曹髦的亲信。<br>焦伯，三国时期人物，魏帝曹髦护卫，官拜黄门从官。<br>曹髦见自己权力威势日渐削弱，感到不胜忿恨，于公元260年（甘露五年）五月初六夜里，令李昭和焦伯等在陵云台布署甲士，出讨司马昭，但最终失败，曹髦为成济所弑，李昭和焦伯等应该也战死。在《三国演义》里，焦伯挺枪出战成济，亦被成济所杀。",
			chengji:
				"成济（？～260年6月21日），三国时期曹魏官员。官至太子舍人。在魏帝曹髦起兵讨司马昭时，受到司马昭之心腹贾充指使，刺死曹髦。司马昭为平息众怒，将成倅、成济兄弟二人杀死。",
			yangfeng:
				"杨奉（？－197年/198年），东汉末年将领。杨奉早年参加白波军起义，曾经帮助李傕对抗郭汜，后来背叛李傕。兴平二年，加号兴义将军，护送汉献帝刘协东归雒阳，颇有功勋，加号车骑将军，屯兵于梁县。建安元年，随着汉献帝迁都许县，失去权力，先后依附于袁术、吕布，劫掠徐州和扬州地区。建安二年（一说三年），带兵进犯刘备领地，被刘备诱杀。",
			muludawang:
				"古典小说《三国演义》中的虚构人物，八纳洞主，孟获盟友。擅驱兽法，能行风雨，控制猛兽并指挥它们作战。在法术帮助下最初对蜀军取得一些胜利，但在诸葛亮的喷火木兽将他的动物吓跑后战败，最后死于乱军之中。",
			...
			shichangshi:
				"十常侍，指中国东汉（公元25年—220年）灵帝时期（168年-189年）操纵政权的十二个宦官：张让、赵忠、夏恽、郭胜、孙璋、毕岚、栗嵩、段珪、高望、张恭、韩悝、宋典（在小说《三国演义》里，十常侍指的是指张让、赵忠、封谞、段珪、曹节、侯览、蹇硕、程旷、夏恽、郭胜十人），他们都任职中常侍。玩弄小皇帝于股掌之中，以至灵帝称“张常侍是我父，赵常侍是我母”。十常侍自己横征暴敛，卖官鬻爵，他们的父兄子弟遍布天下，横行乡里，祸害百姓，无官敢管。人民不堪剥削、压迫，纷纷起来反抗。当时一些比较清醒的官吏，已看出宦官集团的黑暗腐败，导致大规模农民起义的形势。郎中张钧在给皇帝的奏章中明确指出，黄巾起义是外戚宦官专权逼出来的，他说：“张角所以能兴兵作乱，万人所以乐附之者，其源皆由十常侍多放父兄、子弟、婚宗、宾客典据州郡，辜确财利，侵略百姓，百姓之怨无所告诉，故谋议不轨，聚为‘盗贼’。”后被曹操、袁绍所歼。",
			sunzhang:
				"孙璋（？-189年？）东汉末期汉灵帝的宦官，官居中常侍，为十常侍之一，在张让、赵忠之下位居第三。光熹元年（189年），张让、赵忠、段珪等诛杀何进，袁绍率军入宫，诛杀孙璋。",
			...
			duangui:
				"段珪（？—189），东汉宦官，十常侍之一。段珪与张让、赵忠等人朋比为奸，党同伐异，横征暴敛，卖官鬻爵，引起了以何进为首的外戚集团的不满。何进谋诛宦官，却不纳曹操、陈琳之谏，多结外镇军阀，翘首京师，与袁绍等谋诛宦竖。终于事泄，被宦官集团查知。张让、段珪等人先下手为强，斩杀何进于嘉德殿前，却也引起了京师的变乱。袁绍等人趁机带兵冲入皇宫，大肆诛杀太监。洛阳卫军变乱后，段珪与张让等人劫持少帝刘辩、陈留王刘协出逃，后被杀。",
			guosheng:
				"郭胜，南阳宛（今河南南阳）人。汉灵帝时为中常侍，与张让、赵忠等狼狈为奸，并皆封侯。曾助同乡何进、何太后贵幸。后被袁绍等人率兵诛灭。",
			gaowang:
				"高望（？~189年），京兆人，东汉宦官，十常侍之一，为小黄门兼任尚药监，颇得皇子刘辩的信任。中平六年（189年），张让等人杀害大将军何进，袁绍与王匡等人率兵杀入雒阳端门，在承明堂上斩杀中常侍高望。",
			qianzhao:
				"牵招（？—231年），字子经，安平郡观津县（今河北省武邑县）人。三国时期曹魏名将。牵招早年师从乐隐，与刘备成为刎颈之交。投靠冀州牧袁绍，担任冀州从事，统领乌丸突骑。袁绍死后，跟随冀州刺史袁尚，受到并州牧高干加害，投奔丞相曹操，授军谋掾。从平乌丸，出任护乌丸校尉。举茂才出身，从平汉中，授中护军。拜平虏校尉，平定东莱郡叛乱。魏文帝曹丕时期，授护鲜卑校尉，驻扎昌平，迁右中郎将、雁门太守，遏制鲜卑轲比能发展壮大。魏明帝即位，赐爵关内侯，营救护乌丸校尉田豫。太和五年，去世。",
			fuqian: "傅佥（？~263年），义阳（治今湖北省枣阳市）人，蜀汉将领傅彤之子，三国时期蜀汉名将。金长于谋略，并颇有胆勇，姜维甚爱之。傅佥官至关中都督。魏国攻伐蜀汉时，傅佥和蒋舒防守阳安关，兵败战死。",
			wangjun:
				"王濬（207年～286年），字士治，小名阿童，弘农郡湖县（今河南省灵宝市阌乡）人。西晋时期名将。王濬出身世家，博学多闻，容颜英俊，多谋善战。举秀才出身，起家河东郡从事。泰始八年（272年），担任广汉太守，平定益州叛乱，迁益州刺史。利用长江上游地势之利，修造战船，组建强大的水军。上书晋武帝，促成晋灭吴之战。咸宁六年（280年），率兵顺流而下，熔毁横江铁链，攻克丹阳郡，率先攻取石头城，接受吴末帝孙皓投降，完成西晋统一大业。凭借功勋，拜辅国将军、步兵校尉，册封襄阳侯。为避猜忌，纵情享受，累迁特进、抚军大将军、开府仪同三司、散骑常侍、后军将军等。太康六年十二月（286年1月18日），王濬去世，享年八十岁，谥号为“武”，安葬于柏谷山。",
			...
			ruanhui:
				"阮氏女，是指三国时期曹魏名士许允之妻阮氏，陈留尉氏人。阮氏女是中国古代四大丑女之一，貌丑而见识非凡。她出身士族之家，是卫尉阮共（字伯彦）之女、阮侃（字德如）之妹。嫁与许允后生有二子：许奇，官至司隶校尉；许猛，官至幽州刺史。",
			...
			jiangwan:
				"蒋琬（？－246年），字公琰。零陵郡湘乡县人。三国时期蜀汉政治家，与诸葛亮、董允、费祎合称“蜀汉四相”。蒋琬最初随刘备入蜀，为广都县长。因其不理政事，惹怒刘备，在诸葛亮的劝说下才免于一死。后重获启用，受到诸葛亮的悉心培养，累官丞相长史兼抚军将军。建兴十二年（234年），诸葛亮去世，蒋琬继其执政，拜尚书令，又加行都护、假节，领益州刺史，再迁大将军，录尚书事，封安阳亭侯。延熙元年（238年），受命开府，加大司马，总揽蜀汉军政。曾制定由水路进攻曹魏的计划，但未被采纳。延熙九年（246年），蒋琬病逝，谥号为恭。",
			sunhanhua:
				"孙寒华，三国时女仙。梁·陶弘景《真诰》卷一三、五代·杜光庭《墉城集仙录》卷七：其父孙贲为孙权堂兄，寒华少时与杜契有私情，后从杜契受玄白之要，颜容日少。周旋吴越诸山十馀年，得道仙去。《鉴后集》卷四：一云即吴大帝孙权之女。于茅山修道，道成，冲虚而去，因号其山为华姥山。山在茅山崇禧观前。《神异典》卷二五九人于明代，误。",
			yanpu: "阎圃，生卒年不详，是益州巴西安汉（今四川省南充市）人。张鲁割据巴、汉，就以阎圃为功曹。东汉末年人物，本为张鲁部下谋士，后随张鲁一同投降曹操，封平乐乡侯。",
			mayuanyi:
				"马元义（？—184年6月7日），东汉末年黄巾之乱的组织者之一，是黄巾大方首领。光和六年（183年），马元义奉黄巾军首领张角之命，筹划起事的准备工作。马元义聚集荆州、扬州信徒数万人约定于邺城相会，并收买中常侍封谞、徐奉等为内应，准备于次年（甲子年）三月初五（戊申日）内外同时起事。由于张角弟子济南人唐周的告密，马元义于于中平元年（184年）正月在河内郡山阳县被捕，送往洛阳车裂，同时被杀的还有教众近千人。由于马元义的被杀，迫使张角提前于二月起兵发动叛乱。",
			...
			sunchen:
				"孙綝（231年－259年1月18日），字子通，吴郡富春（今浙江杭州市富阳区）人。三国时期吴国宗室、权臣，昭义中郎将孙静曾孙、定武中郎将孙暠之孙、安民都尉孙绰的儿子。门荫入仕，初任偏将军。太平元年（256年），升任侍中、武卫将军、都督中外诸军事。掌权以后，诛杀大司马滕胤、骠骑将军吕据等重臣，升任大将军，册封永宁县侯。嗜好杀戮，与皇帝孙亮的矛盾激化，最终废黜孙亮，拥立琅琊王孙休即位，累迁丞相、荆州牧。永安元年十二月（259年1月），在左将军张布的协助下，遭到皇帝孙休捕杀，时年二十八岁，削除宗籍，改姓故氏。",
			qiaozhou:
				"谯周（201年－270年），字允南，巴西郡西充国县（今四川西充县槐树镇）人。三国时期蜀汉大臣、学者、儒学家、史学家。幼年丧父，少读典籍，精研六经，颇晓天文，成为蜀地大儒之一，门下有陈寿、罗宪等学生。诸葛亮担任益州牧时，授劝学从事。诸葛亮死后，不顾朝令，前往奔丧。后主刘禅册立太子时，授太子仆，迁太子家令、光禄大夫。反对姜维北伐，著《仇国论》，力陈北伐之失。炎兴元年（263年），邓艾攻打成都时期，力劝刘禅投降，“有全国之功”，投降魏国后，受封阳城亭侯，迁骑都尉。泰始六年（270年），授散骑常侍，同年去世，时年七十岁。",
			gongsunkang:
			...
			zhouqun:
				"周群（生卒年不详），字仲直，巴西阆中（今四川阆中）人。周群年少时随父周舒学习占验天算之术。后来刘璋聘请周群为师友从事，其预言大多得以应验。刘备割据益州，任命周群为儒林校尉。曾劝说刘备攻汉中必定不利，事后得到应验，被举荐为茂才。",
			dongzhao:
			...
			yanghuiyu:
				"羊徽瑜（214年－278年），泰山南城（今山东新泰）人，晋景帝司马师第三任妻子。羊徽瑜出身官宦世家泰山羊氏，她是南阳太守羊续的孙女，上党太守羊衜之女；其母为东汉名士左中郎将蔡邕之女、蔡文姬的姐妹。羊徽瑜聪慧贤德，嫁给司马师后未有子女。以司马师之弟司马昭的次子司马攸为继子。司马师死后，司马攸侍奉羊徽瑜非常孝顺。泰始元年（265年），司马昭长子司马炎受禅登基，建立西晋，追谥伯父司马师为景皇帝。泰始二年（266年），尊奉羊徽瑜为景皇后，因居弘训宫，故称弘训太后。咸宁四年（278年），羊徽瑜去世，时年六十五岁，谥号景献皇后，与司马师合葬峻平陵。",
			dingyuan:
				"丁原（？—189年），字建阳，兖州泰山郡南城县（山东省平邑县郑城镇）人。东汉末年军阀，官拜执金吾、并州刺史。任并州刺史期间，他亲近、善待主簿吕布，又调遣部下张杨、张辽等名将到洛阳任职。汉灵帝驾崩后，带兵进入洛阳，担任执金吾，并与大将军何进谋划诛杀十常侍，但不久事情败露，何进被宦官杀死。在宦官被诛灭之后，丁原与军阀董卓在废帝问题上意见不合产生矛盾，于是董卓诱使吕布将其杀害，其势力亦被吞并。",
			furong: "傅肜（？－222年），义阳（今湖北枣阳）人，三国时蜀汉将领。刘备攻伐吴国时，傅肜为别督。后刘备被陆逊击败，傅肜率部断后，奋战至死。死前怒斥道：“吴狗！何有汉将军降者！”",
			zhengxuan:
				"郑玄（127年－200年），字康成。北海郡高密县（今山东省高密市）人。东汉末年儒家学者、经学大师。郑玄曾入太学攻《京氏易》、《公羊春秋》及《三统历》、《九章算术》，又从张恭祖学《古文尚书》、《周礼》和《左传》等，最后从马融学古文经。游学归里之后，复客耕东莱，聚徒授课，弟子达数千人，家贫好学，终为大儒。党锢之祸起，遭禁锢，杜门注疏，潜心著述。晚年守节不仕，却遭逼迫从军，最终病逝于元城，年七十四。郑玄治学以古文经学为主，兼采今文经学。他遍注儒家经典，以毕生精力整理古代文化遗产，使经学进入了一个“小统一时代”。著有《天文七政论》、《中侯》等书，共百万余言，世称“郑学”，为汉代经学的集大成者。唐贞观年间，列郑玄于二十二“先师”之列，配享孔庙。宋代时被追封为高密伯。后人建有郑公祠以纪念。",
			dengzhi:
			...
			dongcheng:
				"董承（？~200年），字号不详，冀州河间人（今河北献县）人。东汉末年外戚大臣，汉灵帝母亲董太后侄子，汉献帝嫔妃董贵人之父。初从西凉军，为董卓女婿牛辅部曲。护卫汉献帝刘协从长安东归洛阳，拜为卫将军，受封列侯。建安四年（199年），拜车骑将军。自称领受汉献帝衣带诏，联合刘备、种辑、吴子兰、王子服、吴硕等人密谋诛杀曹操。五年正月，图谋泄露，董承诸人及董贵人全部遇害。",
			chendeng:
				"陈登（163—201），字元龙，下邳淮浦（今江苏涟水西）人。东汉末年将领、官员。沛相陈珪之子。为人爽朗，性格沈静，智谋过人，少年时有扶世济民之志，并且博览群书，学识渊博。二十五岁时，举孝廉，任东阳县长。虽然年轻，但他能够体察民情，抚弱育孤，深得百姓敬重。后来，徐州牧陶谦提拔他为典农校尉，主管一州农业生产。他亲自考察徐州的土壤状况，开发水利，发展农田灌溉，使汉末迭遭破坏的徐州农业得到一定程度的恢复，百姓们安居乐业，“秔稻丰积”。建安初奉使赴许，向曹操献灭吕布之策，被授广陵太守。以灭吕布有功，加伏波将军。又迁东城太守。年三十九卒。其子陈肃，魏文帝时追陈登之功，为郎中。",
			yangbiao:
			...
			hujinding:
				"胡金定，女，传说中关羽之妻。关索之母，配偶关羽，出处《花关索传》和元代《三国志评话》民间传说人物。",
		},
		characterTitle: {},
		card: {
			ly_piliche: {
		...
		skill: {
					...
					order(item, player) {
						if (
							...
							game.hasPlayer((current) => {
								return (
									current !== player && get.effect(current, "mbzuoyou", player, player) > 0
								);
							})
						)
			...
			mbkuangli: {
				...
				subSkill: {
					target: {
						...
						filter(event, player) {
							return (
								event.target.hasSkill("mbkuangli_mark") &&
								[player, event.target].some((current) => current.countCards("he"))
							);
						},
						forced: true,
						logTarget: "target",
						...
						ai: {
							effect: {
								player(card, player, target, current) {
									...
									if (
										counttrigger &&
										counttrigger.mbkuangli_target &&
										counttrigger.mbkuangli_target >= lib.skill.mbkuangli_target.usable
									)
										return;
				...
				subSkill: {
					inphase: {
						...
						filter(event, player) {
							...
							return (
								target !== player &&
								target.countCards("h") >= target.getHp() &&
								target.hasEnabledSlot(1)
							);
						},
						prompt2: "废除其的武器栏",
						logTarget: "target",
			...
			mbkuili: {
				...
				filter(event, player) {
					return (
						...
						(event.source && event.source.isIn() && event.source.hasDisabledSlot(1))
					);
				},
				forced: true,
				async content(event, trigger, player) {
					if (player.countCards("h") > 0) {
						await player.chooseToDiscard(
							`溃离：请弃置${get.cnNumber(trigger.num)}张手牌`,
							trigger.num,
							true
						);
					}
			...
			mbqianlong: {
				...
				filter(event, player) {
					let skills = [];
					if (player.additionalSkills && player.additionalSkills.mbqianlong)
						skills.addArray(player.additionalSkills.mbqianlong);
				...
				async content(event, trigger, player) {
					player.addAdditionalSkill(
						"mbqianlong",
						lib.skill.mbqianlong.derivation.slice(
							0,
				...
				subSkill: {
					...
					add: {
						...
						async content(event, trigger, player) {
							let toAdd =
								5 *
								(1 + (trigger.name === "damage") + (event.triggername === "damageSource"));
			...
			mbcmqingzheng: {
				...
				content() {
					...
					var num = 2;
					var prompt =
						"###" + get.prompt("sbqingzheng") + "###弃置" + get.cnNumber(num) + "种花色的所有牌";
					var next = player.chooseButton(
						[prompt, [lib.suit.map((i) => ["", "", "lukai_" + i]), "vcard"]],
						num
					);
					next.set("filterButton", (button) => {
						...
						return (
							cards.length > 0 &&
							cards.filter((card) => lib.filter.cardDiscardable(card, player, "sbqingzheng"))
								.length == cards.length
						);
					});
					next.set("ai", (button) => {
					...
					next.set("custom", {
						replace: {
							button: function (button) {
								...
								if (cards.length) {
									var chosen =
										cards.filter((i) => ui.selected.cards.includes(i)).length ==
										cards.length;
									if (chosen) {
						...
						if (button.link === 2) {
							if (
								game.hasPlayer((target) => {
									if (
										target.hasSkill("mbcmfangzhu_ban") ||
										target.hasSkill("fengyin") ||
										target.hasSkill("baiban")
									)
										return false;
									return (
										...
										["name", "name1", "name2"]
											.map((sum, name) => {
												if (
													target[name] &&
													(name != "name1" || target.name != target.name1)
												) {
					...
					xiangsicunwei: {
						...
						filter(event, player) {
							...
							return event.getd().some((card) => {
								return (
									nameList.includes(get.name(card, false)) &&
				...
				ai: {
					...
					result: {
						target(player, target) {
							...
							if (
								(status === 0 && player.storage.mbxuetu) ||
								(status === 1 && !ui.selected.cards.length)
							)
								return 2;
						...
						async content(event, trigger, player) {
							const targets = await player
								...
								.set("ai", (target) => {
									...
									return (
										1 +
										(Math.sqrt(Math.abs(get.attitude(player, target))) *
											Math.abs(get.threaten(target))) /
			...
			sidai: {
				...
				filter: function (event, player) {
					...
					return event.filterCard(
						get.autoViewAs({ name: "sha", storage: { sidai: true } }, cards),
						player,
						event
					);
				},
			...
			shoufa: {
				...
				async content(event, trigger, player) {
					...
					switch (shoufa) {
						...
						case "鹰":
							player.gain(
								target.getGainableCards(player, "he").randomGet(),
								target,
								"giveAuto"
							);
							break;
						case "熊":
							target.discard(target.getGainableCards(player, "e").randomGet()).discarder =
								player;
							break;
						case "兔":
							target.draw();
				...
				content: function* (event, map) {
					...
					for (var i = 0; i <= 2; i++) {
						...
						if (player.hasSkill(skill)) {
							...
							var targetx = nums.sort(
								(a, b) =>
									storage[1][storage[0].indexOf(a)] - storage[1][storage[0].indexOf(b)]
							);
							targetx = targetx.filter(
								(target) =>
									storage[1][storage[0].indexOf(target)] ==
									storage[1][storage[0].indexOf(targetx[0])]
							);
					...
					if (targets.length) {
						var result = yield player
							...
							.set("ai", (target) => {
								return (
									Math.sqrt(Math.min(3, target.countCards("h"))) *
						...
						if (result.bool) {
							...
							var result2 = yield player
								...
								.set(
									"prompt2",
									'<div class="text center">将选择的牌交给另一名其他角色或弃置此牌</div>'
								);
							if (result2.bool) {
								...
								if (!game.hasPlayer((targetx) => targetx != player && targetx != target))
									...
									result3 = yield player
										.chooseTarget(
											"是否令另一名其他角色获得" + get.translation(cards) + "？",
											(card, player, target) => {
				...
				subSkill: {
					...
					1: {
						...
						filter: function (event, player) {
							return (
								event.type == "discard" &&
								game.hasPlayer((target) => event.getl(target).cards2.length)
							);
						},
						forced: true,
						popup: false,
			...
			zhouxian: {
				...
				content: function* (event, map) {
					...
					var result = yield target
						.chooseToDiscard(
							"he",
							"州贤：弃置一张其中有的类别的牌，或令此牌对" + get.translation(player) + "无效",
							(card, player) => {
								return _status.event.cards.some(
			...
			mbyilie: {
				...
				content: function () {
					"step 0";
					player
						.chooseTarget(get.prompt2("mbyilie"), lib.filter.notMe)
			...
			mbyilie2: {
				...
				filter: function (event, player, name) {
					...
					if (name == "damageSource")
						return event.source == target && event.player != target && player.isDamaged();
			...
			naxue: {
				...
				content: function* (event, map) {
					...
					if (num) {
						var result = yield player
							.chooseToDiscard("纳学：是否弃置任意张牌并摸等量的牌？", "he", [1, num])
			...
			mutao: {
				...
				content: function () {
					...
					if (target.getExpansions("mutao").length) {
						...
						event.togive.damage(
							Math.min(2, event.togive.countCards("h", { name: "sha" })),
							target
						);
					}
				},
				...
				content: function () {
					...
					if (
						...
						!player.getStorage("twjichou").filter(function (name) {
							return (
								!player.getStorage("jilun").includes(name) &&
				...
				subSkill: {
					...
					effect: {
						...
						content: function () {
							...
							player
								.chooseButton([
									'###机论：请选择你要执行的选项###<div class="text center"><li>失去1枚“机论”标记，视为使用一张〖急筹〗已记录但〖机论〗未记录的普通锦囊牌<br><li>失去所有“机论”标记</div>',
									[list, "vcard"],
								])
			...
			jiaohua: {
				...
				chooseButton: {
					...
					chooseControl: function (event, player) {
						var list = ["basic", "trick", "equip"].filter(
					...
					check: function (event, player) {
						var list = ["trick", "equip", "basic"].filter(
							(type) => !player.getStorage("jiaohua").includes(type)
						);
						return list[0];
					},
			...
			luanqun: {
				...
				content: function () {
					...
					var cardx = cards.filter(
						(cardy) =>
							cardy != card &&
							get.color(cardy, targets[cards.indexOf(cardy)]) == get.color(card, player)
					);
					if (cardx.length) {
						player
					...
					targets = targets.filter(
						(target) =>
							get.color(cards[targets.indexOf(target)], target) != get.color(card, player)
					);
					if (targets.length) {
						player.line(targets);
						targets.forEach((target) => {
					...
					effect: {
						...
						mod: {
							playerEnabled: function (card, player, target) {
								...
								if (
									card.name == "sha" &&
									!player.getStorage("luanqun_effect").includes(target)
								)
									return false;
							},
						},
						...
						player
							...
							.set(
								...
								lib.skill.mbhuiyao.getUnrealDamageTargets(
									player,
									[game.filterPlayer((i) => i != player), game.filterPlayer()],
									true
								)
							);
					"step 2";
						...
						if (target.isHealthy()) event._result = { index: 0 };
							...
							target
								...
								.set("ai", () => {
									...
									return get.effect(player, { name: "draw" }, player, player) * len >=
			...
			yichong: {
				...
				content: function () {
					...
					player
						.chooseTarget(
							get.prompt("yichong"),
							"选择一名其他角色并选择一个花色，获得其此花色的所有牌并令其获得“雀”标记",
							lib.filter.notMe
						)
						.set("ai", function (target) {
							var player = _status.event.player;
					...
					gain: {
						...
						filter: function (event, player) {
							...
							return game.hasPlayer(function (current) {
								if (
									!event.getg(current).length ||
									!current.hasSkill("yichong_" + player.playerid)
								)
									return false;
								if (
									current.countMark("yichong_" + player.playerid) >=
									lib.skill.yichong.getLimit
								)
									return false;
								return event
									.getg(current)
									.some(
										(card) =>
											get.suit(card, current) == player.storage.yichong &&
						...
						content: function () {
							...
							var cards = trigger
								...
								.filter(
									(card) =>
										get.suit(card, target) == player.storage.yichong &&
										lib.filter.canBeGained(card, target, player)
								);
							if (
								cards.length <=
								lib.skill.yichong.getLimit - target.countMark("yichong_" + player.playerid)
							)
								event._result = { bool: true, links: cards };
							else {
								var num =
									lib.skill.yichong.getLimit -
									target.countMark("yichong_" + player.playerid);
								player
									.chooseButton(
										["易宠：获得其中的" + get.cnNumber(num) + "张牌", cards],
										num,
										true
									)
									.set("ai", function (button) {
			...
			wufei: {
				...
				content: function () {
					...
					if (trigger.name == "damage") {
						player
							.chooseBool(
								get.prompt("wufei", target),
								"令" + get.translation(target) + "受到1点无来源伤害"
							)
				...
				conflictMap: function (player) {
					if (!_status.changshiMap) {
						...
						if (!get.isLuckyStar(player)) {
							...
							for (var i of list) {
								var select = list.filter(
									(scs) => scs != i && !_status.changshiMap[i].includes(i)
								);
								_status.changshiMap[i].addArray(
									select.randomGets(get.rand(0, select.length))
								);
							}
						}
					}
			...
			mbmowang: {
				...
				filter: function (event, player) {
					return (
						player.getStorage("mbdanggu").length &&
						event.getParent().name != "giveup" &&
						player.maxHp > 0
					);
				},
				...
				dieContent: function () {
					...
					if (
						player.isIn() &&
						(!_status.mbmowang_return || !_status.mbmowang_return[player.playerid])
					) {
				...
				subSkill: {
					...
					return: {
						...
						filter: function (event, player) {
							return (
								!event._mbmowang_return &&
								event.player.isOut() &&
								_status.mbmowang_return[event.player.playerid]
							);
						},
						content: function () {
							"step 0";
			...
			scschiyan: {
				...
				content: function () {
					...
					var next = player.choosePlayerCard(
						trigger.target,
						"he",
						get.prompt("scschiyan", trigger.target)
					);
					...
					if (cards.length)
						player
							...
							.set("ai", function (target) {
								var player = _status.event.player;
								var att =
									get.attitude(player, target) / Math.sqrt(1 + target.countCards("h"));
				...
				subSkill: {
					effect: {
						...
						content: function () {
							...
							next.player = player;
							next.setContent(
								lib.skill.scsanruo_effect[name == "shan" ? "sha" : name] || function () {}
							);
						},
						sha: function () {
							"step 0";
				...
				subSkill: {
					num: {
						...
						filter: function (event) {
							return (
								["sha", "tao"].includes(event.card.name) &&
			...
			mbshihe: {
				...
				ai: {
					...
					result: {
						player: function (player, target) {
							if (
								(get.realAttitude || get.attitude)(target, player) >= 0 ||
							...
							return get.number(card) >= 10 ||
								(get.number(card) >= 7 && target.countCards("h") <= 2)
								? 1
								: -1;
						},
					},
				...
				subSkill: {
					prevent: {
						...
						filter: function (event, player) {
							...
							return player
								.getStorage("mbshihe_prevent")
								.some((target) => event.player.isFriendOf(target));
						},
						onremove: true,
						forced: true,
						charlotte: true,
							...
							effect: {
								player: function (card, player, target, current) {
									if (get.tag(card, "damage")) {
										...
										if (
											get.mode() == "identity" &&
											player.getStorage("mbshihe_prevent").includes(target)
										)
											bool = true;
										if (
											get.mode() != "identity" &&
											player
												.getStorage("mbshihe_prevent")
												.some((targetx) => target.isFriendOf(targetx))
										)
											bool = true;
			...
			spdaming: {
				...
				change: function (player, num) {
					...
					game.log(
						player,
						(num > 0 ? "获得了" : "减少了") + get.cnNumber(Math.abs(num)) + "点“达命”值"
					);
				},
				content: function () {
					...
					give: {
						...
						filter: function (event, player) {
							...
							return game.hasPlayer((current) => {
								return (
									current != player &&
									current.hasSkill("spdaming") &&
									!current.hasSkill("spdaming_used")
								);
							});
						},
						selectCard: 1,
						...
						check: function (card) {
							...
							if (
								game.hasPlayer((current) => {
									return (
										lib.skill.spdaming_give.filterTarget(null, player, current) &&
										get.attitude(player, current) > 0
									);
								})
							) {
					...
					move: {
						...
						filter: function (event, player) {
							return (
								...
								game.hasPlayer(
									(current) => !current.hasMark("sbanguo_marked") && current != player
								)
							);
						},
						content: function () {
							...
							var prompt2 =
								targets.length == 1
									? "将" +
									  get.translation(targets[0]) +
									  "的“安国”交给一名未获得过“安国”的其他角色"
							...
							if (result.bool) {
								var targets = result.targets;
								if (targets.length == 1) {
									var target1 = game.filterPlayer((current) =>
										current.hasSkill("sbanguo_mark")
									)[0];
							...
							(function () {
								...
								var cards2 = player
									...
									.sort((a, b) => {
										return (
											get.useful(a, player) +
											player.getUseValue(a) / 3 -
											(get.useful(b, player) + player.getUseValue(b) / 3)
										);
									});
			...
			jiebing: {
				...
				content: function () {
					...
					player
						.chooseTarget(
							"借兵：选择一名其他角色",
							get.skillInfoTranslation("jiebing"),
							true,
							(card, player, target) => {
								return (
									player != target &&
									target != _status.event.getTrigger().source &&
								...
								if (
									game.hasPlayer((current) => {
										return (
											current != player &&
											get.attitude(player, current) > 0 &&
											current.countGainableCards(target, "he") > 0
										);
									})
								)
									return [1, 1];
					...
					result: {
						target: function (player, target) {
							...
							if (
								...
								return (
									get.sgnAttitude(player, target) * get.damageEffect(target, player, player)
								);
							return 0;
						},
					},
			...
			yijin: {
				...
				filter: function (event, player) {
					if (
						!game.hasPlayer(
							(current) => current != player && !lib.skill.yijin.getKane(current).length
						)
					)
						return false;
				...
				getValue: function (player, mark, target) {
					...
					switch (mark.slice(6)) {
						...
						case "jinmi":
							...
							return (
								get.effect(target, { name: "lebu" }, player, target) +
								(draw * target.needsToDiscard(2.2)) / dis
							);
						case "guxiong":
							if (target.hasJudge("lebu")) return (-draw * target.needsToDiscard(3)) / dis;
							return (
								(get.effect(target, { name: "losehp" }, target, target) * 2) / dis -
								(draw * target.needsToDiscard(3)) / dis
							);
						case "tongshen":
						...
						case "houren":
							return (
								(Math.min(5, 2 + target.getDamagedHp()) *
				...
				subSkill: {
					...
					clear: {
						...
						filter: function (event, player) {
							...
							return (
								lib.skill.yijin.getKane(event.player).length &&
								event.player.additionalSkills["yijin_" + player.playerid]
							);
						},
						content: function () {
							"step 0";
			...
			buxu: {
				...
				chooseButton: {
					...
					dialog: function (event, player) {
						var num = (player.getStat("skill").buxu || 0) + 1;
						return ui.create.dialog(
							"###补叙###弃置" + get.cnNumber(num) + "张牌并补充一张“六经”"
						);
					},
					prompt: function (links, player) {
						var num = (player.getStat("skill").buxu || 0) + 1;
			...
			jingzhong: {
				...
				content: function () {
					...
					player
						.chooseTarget(
							get.prompt("jingzhong"),
							"获得一名其他角色下回合出牌阶段内使用的牌",
							lib.filter.notMe
						)
						.set("ai", function (target) {
				...
				subSkill: {
					effect: {
						...
						filter: function (event, player) {
							if (
								!player.getStorage("jingzhong_effect").includes(event.player) ||
							...
							return (
								player.getHistory("useSkill", function (evtx) {
									return (
										evtx.skill == "jingzhong_effect" &&
										evtx.event.getParent("phaseUse") == evt
									);
								}).length < 3
							);
						},
			...
			sbyaoming: {
				...
				content: function () {
					...
					if (
						typeof player.storage.sbyaoming_status == "number" &&
						result.index != player.storage.sbyaoming_status
					) {
			...
			reanxu: {
				...
				content: function () {
					...
					if (
						...
						event.target =
							targets[targets[0].countCards("h") > targets[1].countCards("h") ? 1 : 0];
						player
					...
					effect: {
						...
						filter: function (event, player) {
							...
							return (
								...
								event.player.hasUseTarget({ name: "jiu", isCard: true }, null, true)
							);
						},
						round: 1,
						logTarget: "player",
							...
							player
								...
								.set(
									...
									"你觉得" +
										...
										"的手牌区里有" +
										get.translation(event.cardname) +
										"吗？"
								)
								.set("ai", function () {
								...
								.set(
									...
									(function () {
										...
										return 1 - Math.pow(1 - rand, target.countCards("h")) > 0.5
											? "有！"
											: "没有！";
									})()
								);
						...
						content: function* (event, map) {
							...
							var result = yield target
								...
								.set("filterButton", (button) => {
									...
									if (typeof button.link == "string")
										return (
											get.name(ui.selected.buttons[0].link, false) != map[button.link]
										);
								...
								.set("ai", (button) => {
										...
										if (typeof button.link == "object") {
											if (
												Object.values(map).some((name) =>
													lib.card.list.some(
														(card) =>
															card[0] == get.suit(button.link, false) &&
									...
									if (typeof button.link == "string") {
										...
										if (
											lib.card.list.some(
												(card) =>
													card[0] == get.suit(cardx, false) &&
													card[1] == get.number(cardx, false) &&
													card[2] == map[button.link]
											)
										)
							...
							if (result.bool) {
								...
								var card = game.createCard(
									ChangeName,
									get.suit(OriginCard, false),
									get.number(OriginCard, false)
								);
								cards[cards.indexOf(OriginCard)] = card;
								if (_status.connectMode) {
									var list = targets.map((target2) => [
										target2,
										["请猜测" + get.translation(target) + "伪装的手牌", cards],
										true,
									]);
									var result2 = yield player
										.chooseButtonOL(list)
										...
										var result2 = yield target2
											...
											.set("ai", (button) => {
												...
												var card = cards.find(
													(card) =>
														lib.card.list.some(
															(cardx) => cardx[2] == get.name(card, false)
														) &&
														!lib.card.list.some(
															(cardx) =>
								...
								targets.forEach((target2) => {
									if (guessWinner.includes(target2)) {
										...
										if (target2.countCards("h") >= 2)
											target2.discard(target2.getCards("h").randomGets(2));
										else target2.loseHp();
									}
								});
							}
			...
			spdaizui: {
				...
				content: function () {
					...
					trigger.source
						.addToExpansion(trigger.cards.filterInD(), "gain2")
						.gaintag.add("spdaizui2");
					trigger.cancel();
				},
			},
			spdaizui2: {
				...
				mod: {
					cardUsable: function (card, player) {
						if (typeof card == "object") {
							...
							if (
								num1 === "unsure" ||
								(typeof num1 == "number" && typeof num2 == "number" && num1 % num2 == 0)
							)
								return Infinity;
						}
					},
					aiOrder: function (player, card, num) {
						if (typeof card == "object") {
							...
							if (
								num1 === "unsure" ||
								(typeof num1 == "number" && typeof num2 == "number" && num2 % num1 == 0)
							)
								return num + 5;
						}
					},
						...
						if (!player.storage.mobileyanzhu || event.targets2.length == 1)
							...
							event.current.chooseCardTarget({
								...
								filterTarget: function (card, player, target) {
									return (
										target != player &&
										_status.event.getParent().targets2.includes(target)
									);
								},
								forced: true,
								selectTarget: [0, 1],
			...
			mobileyanzhu: {
				...
				content: function () {
					...
					if (target.countCards("e")) {
						target
							.chooseBool(
								"是否将装备区内的所有牌交给" + get.translation(player) + "？",
								"若选择“取消”，则其将获得你区域里的一张牌"
							)
							.set("ai", function () {
						...
						.set("ai", function (target) {
							...
							if (preTarget) {
								if (get.attitude(player, preTarget) < 0) eff += 4;
									...
									preTarget.hasValueTarget({ name: "sha" }, false) &&
									!preTarget.hasValueTarget({ name: "sha" })
								)
									eff -= 3;
							}
							if (
			...
			spshidi: {
				...
				filter: function (event, player) {
					return (
						player.countMark("spshidi") % 2 == ["phaseJieshu", "phaseZhunbei"].indexOf(event.name)
					);
				},
				content: function () {
			...
			chongxu: {
				...
				beatmaps: [
					...
					},
					{
						...
						timeleap: [
							1021, 1490, 1959, 2896, 3834, 4537, 4771, 5709, 6646, 7585, 8039, 8494, 9403,
							10291, 11180, 11832, 12049, 12920, 13345, 13771, 14196,
						],
						current: -110,
						judgebar_height: 0.16,
						range1: [84, 110],
					...
					},
					{
						...
						timeleap: game.generateBeatmapTimeleap(
							170,
							[0, 4, 8, 12, 14, 16, 16.5, 23.5, 24, 31, 32, 40, 45, 46, 47]
						),
						current: -110,
						judgebar_height: 0.16,
						range1: [84, 110],
					...
					},
					{
						...
						mapping: "random",
						timeleap: [
							0, 1071, 1518, 2054, 4018, 4286, 5357, 6429, 7500, 8571, 9643, 10714, 11786,
							12321, 12589, 12857, 13929, 15000, 16071, 17143, 18214, 18482, 18750, 19018,
							19286, 20357,
						],
						current: -110,
						judgebar_height: 0.16,
					...
					},
					{
						...
						number_of_tracks: 7,
						mapping: [
							3, 6, 4, 5, 6, 2, 3, 2, 1, 2, 0, 4, 3, 6, 5, 4, 3, 6, 3, 2, 3, 1, 0, 1, 2, 3, 4,
							5, 6,
						],
						timeleap: game.generateBeatmapTimeleap(
							107,
							[
								2, 3.5, 4.5, 5.5, 6.5, 8.5, 10, 11.5, 12.5, 13.5, 14.5, 15.5, 18, 19.5, 20.5,
								21.5, 22.5, 24.5, 26, 27.5, 28.5, 29.5, 30.5, 31, 31.5, 32, 32.5, 33, 33.5,
							]
						),
					...
					},
					{
						...
						timeleap: game.generateBeatmapTimeleap(
							96,
							[4, 6, 8, 9, 10, 11, 12, 13.5, 14, 15.5, 16, 17, 18, 19]
						),
						current: -110,
						judgebar_height: 0.16,
						range1: [84, 110],
					...
					},
					{
						...
						timeleap: game.generateBeatmapTimeleap(
							170,
							[
								3, 4, 6, 6.5, 7.5, 11, 12, 14, 14.5, 15.5, 19, 20, 22, 22.5, 23.5, 27, 28, 30,
								30.5, 31.5, 35, 36, 38, 38.5, 39.5, 43, 44, 46, 46.5, 47.5, 51, 52, 54, 54.5,
								55.5, 59, 60, 62, 62.5,
							]
						),
						current: -110,
			...
			huantu: {
				...
				content: function () {
					...
					player
						.chooseCard(
							get.prompt("huantu", trigger.player),
							"交给其一张牌并令其暂时跳过摸牌阶段",
							"he"
						)
						.set("ai", function (card) {
			...
			jibing: {
				...
				chooseButton: {
					dialog: function (event, player) {
						...
						if (
							...
							dialog._cardName = event.filterCard(
					...
					filter: function (button) {
						...
						if (evt.dialog) {
							if (!evt.dialog._chooseButton) {
								...
								return evt2.filterCard(
									get.autoViewAs({ name: evt.dialog._cardName }, [button.link]),
									player,
									evt2
								);
							}
							if (ui.selected.buttons.length) {
								...
								var evt2 = _status.event.getParent();
								return evt2.filterCard(
									get.autoViewAs({ name: str }, [button.link]),
									player,
									evt2
								);
							}
					...
					backup: function (links, player) {
						...
						if (links.length == 2) {
							...
							name = event.filterCard(get.autoViewAs({ name: "sha" }, [card]), player, event)
								? "sha"
								: "shan";
						}
						return {
				...
				subSkill: {
					place: {
						...
						trigger: { player: "phaseDrawBegin1" },
						prompt2:
							"摸牌阶段开始时，若你的“兵”数小于势力数，则你可以改为将牌堆顶的两张牌置于你的武将牌上，称为“兵”。",
						filter: function (event, player) {
							return (
								!event.numFixed && player.getExpansions("jibing").length < game.countGroup()
							);
						},
						content: function () {
							trigger.changeToZero();
						...
						!player.storage.jueyong[0].some(function (card) {
							return (
								get.effect(
									player,
									card,
									player.storage.jueyong[1][player.storage.jueyong[0].indexOf(card)],
									player
								) < 0
							);
						})
						...
						game.hasPlayer(function (current) {
							return (
								...
								(!player.storage.discretesidi ||
									!player.storage.discretesidi.includes(current))
							);
						})
					);
				},
						...
						.chooseTarget(
							...
							function (card, player, target) {
								...
								return (
									target != player &&
									(!player.storage.discretesidi ||
										!player.storage.discretesidi.includes(target))
								);
							}
						)
					...
					content: function (storage, player) {
						if ((player == game.me || player.isUnderControl()) && !game.observe) {
							...
							for (var i = 0; i < storage.length; i++) {
								str +=
									"&lt;" +
									get.translation(storage[i]) +
									", " +
									get.translation(player.storage.discretesidi2[i]) +
									"&gt;";
				...
				subSkill: {
					clear: {
						...
						filter: function (event, player) {
							if (
								!player.storage.discretesidi ||
								!player.storage.discretesidi.includes(event.player)
							)
								return false;
							if (event.name == "die") return true;
							if (get.type(event.card, false) != "delay") {
								...
								return (
									index != -1 &&
									(player.storage.discretesidi2[index] != event.target ||
										event.targets.length != 1)
								);
							}
							return false;
						...
						content: function () {
							player.storage.discretesidi2.splice(
								player.storage.discretesidi.indexOf(trigger.player),
								1
							);
						...
						content: function () {
							...
							player
								...
								.set("ai", function () {
									...
									if (
										get.damageEffect(evt.player, player, player) > 0 &&
			...
			xinzenhui: {
				...
				filter: function (event, player) {
					...
					if (
						card.name != "sha" &&
						(get.type(card, null, false) != "trick" || get.color(card, false) != "black")
					)
						return false;
				...
				content: function () {
					...
					if (result.bool) {
						...
						game.log(
							player,
							"将",
							get.position(result.cards[0]) == "e" ? result.cards[0] : "#y一张手牌",
							"置于了牌堆顶"
						);
						player.lose(result.cards, ui.cardPile, "insert");
					} else event.finish();
			...
			xinshenxing: {
				...
				filter: function (event, player) {
					return (
						(player.getStat("skill").xinshenxing || 0) < player.hp && player.countCards("he") > 1
					);
				},
				selectCard: 2,
				position: "he",
			...
			mobilezhongyong: {
					...
					for (var i of event.targets) {
						list.addArray(
							i.getHistory("useCard", function (evt) {
								return (
									evt.card.name == "shan" && evt.respondTo && evt.respondTo[1] == event.card
								);
							})
						);
					}
				...
				content: function () {
					...
					if (list.length) {
						...
						player
							.chooseBool(get.prompt("mobilezhongyong"), "获得" + get.translation(event.shas))
							.set("ai", function () {
								var evt = _status.event.getParent();
					...
					if (
						...
						choiceList.push(
							"令另一名其他角色获得" +
								shans +
								"，然后你于本回合内使用【杀】的次数上限+1且下一张【杀】的伤害值基数+1"
						);
					}
					player
						.chooseControl("cancel2")
					...
					if (
						...
						player
							.chooseTarget(
								"是否令一名其他角色获得" + get.translation(event.shas) + "？",
								function (card, player, target) {
									return (
										target != player &&
					...
					player
						.chooseTarget(
							...
							function (card, player, target) {
								return (
									target != player && !_status.event.getTrigger().targets.includes(target)
								);
							}
						)
						.set("ai", function (target) {
			...
			tiansuan: {
				...
				content: function () {
					...
					event.num = num;
					var str =
						get.translation(player) + "抽取的命运签为：" + lib.skill["tiansuan2_" + num].name;
						...
						draw: function () {
							switch (state.curr) {
								...
								case state.gameSuccess:
									...
									ctx.drawImage(
										(state.curr == state.gameOver ? this.gameOver : this.gameClear)
											.sprite,
										this.x,
										this.y
									);
				...
				content: function () {
					...
					var chooseButton = function () {
						...
						event.dialog.textPrompt = event.dialog.add(
							'<div class="text center">准备好了吗？准备好了的话就点击屏幕开始吧！</div>'
						);
						var max = Math.max(2, 1 + game.me.countMark("yufeng"));
						...
						bird.updatePosition = function () {
							bird.style.transform =
								"translateY(" + ((top / 100) * height - bird.offsetTop) + "px)";
						};
						...
						var fly = function () {
							if (!start) {
								...
								event.dialog.textPrompt.innerHTML =
									'<div class="text center">当前分数：' + event.score + "</div>";
								speed = -4;
								...
								var addPipe = function () {
									...
									pipe1.style["background-image"] =
										"linear-gradient(rgba(57, 133, 4, 1), rgba(60, 135, 6, 1))";
									...
									pipe2.style["background-image"] =
										"linear-gradient(rgba(57, 133, 4, 1), rgba(60, 135, 6, 1))";
									pipe2.style["border-radius"] = "3px";
									pipe1.pipe2 = pipe2;
									pipe2.style.position = "absolute";
									pipe2.style.height =
										Math.ceil(((100 - pipe1.height2) * height) / 100) + "px";
									...
									pipe1.updateLeft = function () {
										this.style.transform =
											"translateX(" +
											((this.left / 100) * width - this.offsetLeft) +
											"px)";
										this.pipe2.style.transform =
											"translateX(" +
											((this.left / 100) * width - this.pipe2.offsetLeft) +
											"px)";
										if (this.left < 25 && !this.score) {
											this.score = true;
											event.score++;
											event.dialog.textPrompt.innerHTML =
												'<div class="text center">当前分数：' +
												event.score +
												"</div>";
											if (event.score >= max) {
												event.settle();
			...
			xinduodao: {
				...
				prompt2: function (event, player) {
					...
					var cards = source
						.getEquips(1)
						.filter((card) => lib.filter.canBeGained(card, player, source));
					return "获得其装备区中的" + get.translation(cards);
				},
				check: function (event, player) {
					return (
						(get.attitude(player, event.source) + 0.1) *
						get.value(event.source.getEquip(1), event.source)
					);
				},
				content: function () {
					var source = trigger.source;
			...
			liyong3: {
				...
				filter: function (event, player) {
					return (
						...
						event.card.name == "sha" &&
						event.player.isIn() &&
						event.getParent(2).liyong2 == true
					);
				},
				content: function () {
					player.loseHp();
				...
				content: function () {
					...
					player.gainPlayerCard(target, "e", true).set("ai", function (button) {
						...
						if (
							...
							get.damageEffect(_status.event.target, player, player) > 0
						)
							return 6 + get.value(card);
						return get.value(card);
					});
				...
				ai: {
					...
					result: {
						target: function (player, target) {
							...
							var distance2 = Math.pow(
								get.distance(player, ui.selected.targets[0], "absolute"),
								2
							);
			...
			mobiledanshou: {
				...
				content: function () {
					...
					player
						.chooseToDiscard(
							num,
							get.prompt("mobiledanshou", trigger.player),
							"弃置" + get.translation(num) + "张牌并对其造成1点伤害",
							"he"
						)
						.set("ai", function (card) {
							if (!_status.event.goon) return 0;
						...
						.set("goon", get.damageEffect(trigger.player, player, player) > 0).logSkill = [
						"mobiledanshou",
						trigger.player,
					];
					"step 3";
					...
					if (trigger.name == "chooseToCompare" && trigger.compareMeanwhile) {
						...
						if (player == trigger.player) {
							if (trigger.num1 > trigger.num2 && get.position(trigger.card2, true) == "o") {
								...
								trigger.num1 < trigger.num2 &&
								get.position(trigger.card1, true) == "o"
							) {
								str += "/拼点牌";
							...
							if (trigger.num1 < trigger.num2 && get.position(trigger.card1, true) == "o") {
								...
								trigger.num1 > trigger.num2 &&
								get.position(trigger.card2, true) == "o"
							) {
								str += "/拼点牌";
								cards.push(trigger.card2);
							}
			...
			liechi: {
				...
				filter: function (event, player) {
					return (
						event.getParent().name == "damage" && event.source && event.source.countCards("he")
					);
				},
				audio: 2,
				content: function () {
					...
					player.chooseCardTarget({
						...
						selectTarget: function () {
							if (
								...
								!lib.filter.cardDiscardable(ui.selected.cards[0], _status.event.player)
							)
								return [1, 1];
							return [0, 1];
						},
			...
			xinwanlan: {
				...
				check: function (event, player) {
					...
					if (
						player.countCards("hs", (card) => player.canSaveCard(card, event.player)) >=
					...
					var next = player.chooseCardTarget({
						...
						filterTarget: function (card, player, target) {
							...
							if (target != player && target != trigger.source) {
								if (
									target.hasSkill("zhengjian_mark") &&
				...
				check: function (card) {
					...
					if (
						...
						game.hasPlayer(function (current) {
							return (
								current != player &&
								get.value(card, current) * get.attitude(player, current) > 0
							);
						})
					)
						return 1;
					...
					if (result.bool && game.hasPlayer((current) => current != player)) {
						...
						player
							.chooseTarget(
								true,
								lib.filter.notMe,
								"选择一名其他角色获得" + get.translation(event.card)
							)
							.set("ai", function (target) {
								return (
			...
			zhengjing: {
				...
				content: function () {
					...
					var chooseButton = function (list) {
						...
						event.dialog = ui.create.dialog("forcebutton", "hidden");
						event.dialog.textPrompt = event.dialog.add(
							'<div class="text center">及时点击卡牌，但不要点到毒了！</div>'
						);
						...
						event.settle = function (du) {
							...
							if (du) {
								...
								event.dialog.textPrompt.innerHTML =
									'<div class="text center">叫你别点毒你非得点 这下翻车了吧</div>';
							} else {
								if (lib.config.background_speak) game.playAudio("skill", "zhengjing_finish");
								event.dialog.textPrompt.innerHTML =
									'<div class="text center">整理经典结束！共整理出' +
									get.cnNumber(event.finishedx.length) +
									"份经典</div>";
							}
				...
				content: function () {
					...
					if (result.index == 0) event.goto(5);
						...
						trigger.player.chooseToDiscard(
							"弃置一张牌令" + get.translation(player) + "不能闪避此【杀】",
							"he",
							true
						);
					"step 4";
			...
			rezhengrong: {
				...
				content: function () {
					...
					player
						.chooseTarget(
							get.prompt("rezhengrong"),
							"将一名其他角色的随机一张牌置于你的武将牌上，成为「荣」",
							function (card, player, target) {
								return target != player && target.countCards("he") > 0;
							}
						)
			...
			fengji: {
				...
				filter: function (event, player) {
					return (
						typeof player.storage.fengji == "number" &&
						player.countCards("h") >= player.storage.fengji
					);
				},
				content: function () {
					player.draw(2);
						...
						if (
							game.hasPlayer(function (current) {
								return (
									...
									get.attitude(player, current) > 0 &&
									(current.storage.zhouxuan2.isbasic
										? card.name
										: get.type(card, "trick")) == current.storage.zhouxuan2.card
								);
							})
						)
							return num + 10;
					...
					player.chooseCardTarget({
						filterCard: function (card) {
							return (
								get.color(card) == "red" &&
								get.type(card) == "basic" &&
								lib.filter.cardDiscardable.apply(this, arguments)
							);
						},
						filterTarget: function (card, player, target) {
							return player != target && target.countCards("he") > 0;
						...
						prompt2:
							"弃置一张红色基本牌并选择一名其他角色，将其的至多X张牌置于其武将牌上直到回合结束。（X为你的体力值）",
						ai1: function () {
							return -1;
						},
					});
			...
			yizheng: {
				...
				ai: {
					...
					result: {
						...
						target: (player, target) => {
							if (
								target.skipList.includes("phaseDraw") ||
								target.hasSkill("pingkou") ||
								target.hasSkill("xinpingkou")
							)
								return 0;
							let hs = player.getCards("h").sort(function (a, b) {
								return get.number(b) - get.number(a);
					...
					cardUsable: function (card, player, num) {
						...
						if (card.name == "sha") {
							if (
								...
								cards.some(
									(card) =>
										card != _status.rw_zhuge_temp && !ui.selected.cards.includes(card)
								)
							) {
			...
			xinqingjian: {
				...
				content: function () {
					"step 0";
					player.chooseCard(get.prompt2("xinqingjian"), "he", [1, player.countCards("he")]).ai =
						function () {
							return -1;
						};
					"step 1";
			...
			zhongzuo: {
				...
				filter: function (event, player) {
					return (
						player.getHistory("damage").length > 0 || player.getHistory("sourceDamage").length > 0
					);
				},
				content: function () {
					"step 0";
				...
				content: function () {
					...
					if (result.index == 0) {
						...
						var next = player.chooseUseTarget(
							{ name: trigger.card.name, nature: trigger.card.nature, isCard: true },
							false,
							true
						);
				...
				content: function () {
					...
					var switchToAuto = function () {
						...
						setTimeout(function () {
							...
							event._result = {
								bool: true,
								links: ["qiaosi_c1", "qiaosi_c6"].concat(
									["qiaosi_c2", "qiaosi_c3", "qiaosi_c4", "qiaosi_c5"].randomGets(1)
								),
							};
							if (event.dialog) event.dialog.close();
							if (event.controls) {
					...
					var chooseButton = function (player) {
						...
						for (var i in event.status) {
							event.dialog.content.childNodes[0].innerHTML =
								event.dialog.content.childNodes[0].innerHTML.replace(i, event.status[i]);
						}
			...
			rebiaozhao: {
				...
				content: function () {
					"step 0";
					player.chooseCard("he", get.prompt("rebiaozhao"), "将一张牌置于武将牌上作为“表”").ai =
						function (card) {
							return 6 - get.value(card);
						};
					"step 1";
			...
			wuyuan: {
				...
				check: function (card) {
					...
					if (
						...
						game.hasPlayer(function (current) {
							return (
								current != player && current.isDamaged() && get.attitude(player, current) > 2
							);
						})
					)
						return 2;
			...
			rexushen2: {
				...
				content: function () {
					...
					player.chooseBool(
						"是否令" + get.translation(trigger.source) + "获得技能〖武圣〗和〖当先〗"
					).ai = function () {
			...
			rezhennan: {
				...
				filter: function (event, player) {
					return (
						...
						event.targets.length > event.player.hp
					);
				},
				direct: true,
				content: function () {
					"step 0";
					var next = player.chooseToDiscard(
						get.prompt("rezhennan", trigger.player),
						"弃置一张牌并对其造成1点伤害",
						"he"
					);
				...
				content: function () {
					...
					if (result.bool && result.cards && result.cards.length) {
						if (result.cards.length == 1) {
							...
							player.chooseButton(["选择获得其中的一张牌", result.cards.slice(0)], true).ai =
								function (button) {
									return get.value(button.link);
								};
					} else event.finish();
			...
			xinfu_daigong: {
				...
				content: function () {
					...
					trigger.source
						.chooseCard(
							"he",
							"交给" + get.translation(player) + "一张满足条件的牌，否则防止此伤害。",
							function (card) {
			...
			zhaoxin_give: {
				...
				content: function () {
					...
					player
						.chooseCardButton(
							get.prompt("xinfu_zhaoxin", trigger.player),
							player.getExpansions("xinfu_zhaoxin"),
							function (button) {
								return true;
							}
						)
			...
			rw_renwang_skill: {
				...
				filter: function (event, player) {
					...
					return (
						event.card.name == "sha" &&
						(get.suit(event.card) == "heart" || get.color(event.card) == "black")
					);
				},
				ai: {
					effect: {
			...
			xinfu_pingcai: {
				...
				fengchu_card: function () {
					...
					var ingame = game.hasPlayer(function (current) {
						return (
							["re_pangtong", "pangtong", "ol_pangtong"].includes(current.name) ||
							["re_pangtong", "pangtong", "ol_pangtong"].includes(current.name2)
						);
					})
						? true
						: false;
				...
				xuanjian_card: function () {
					...
					event.ingame = game.hasPlayer(function (current) {
						return (
							["re_xushu", "xin_xushu", "xushu", "dc_xushu"].includes(current.name) ||
							["re_xushu", "xin_xushu", "xushu", "dc_xushu"].includes(current.name2)
						);
					})
						? true
						: false;
				...
				contentx: function () {
					...
					var chooseButton = function (id, name) {
						...
						dialog.textPrompt = dialog.add(
							'<div class="text center">擦拭掉宝物上的灰尘吧！</div>'
						);
						event.switchToAuto = function () {
							event._result = {
			...
			xinfu_pdgyingshi: {
				...
				content: function () {
					...
					game.log(
						player,
						"跳过了",
						event.triggername == "phaseZhunbeiBefore" ? "准备阶段" : "结束阶段"
					);
				},
			},
			xinfu_pdgyingshi2: {
			...
			xinfu_jingxie1: {
				...
				filter: function (event, player) {
					...
					for (var i = 0; i < he.length; i++) {
						if (
							["bagua", "baiyin", "lanyinjia", "renwang", "tengjia", "zhuge"].includes(
								he[i].name
							)
						)
							return true;
				...
				filterCard: function (card) {
					return ["bagua", "baiyin", "lanyinjia", "renwang", "tengjia", "zhuge"].includes(
						card.name
					);
				},
				discard: false,
					...
					skillTagFilter: function (player, arg, target) {
						...
						return player.hasCard(
							(card) =>
								...
								(get.subtype(card) == "equip2" && player.canRecast(card)),
							"he"
						);
					},
					save: true,
				...
				subSkill: {
					choose: {
						...
						content: function () {
							...
							if (nh) {
								player
									.chooseCard("h", [1, nh], "将任意张手牌置于你的武将牌上")
									.set("ai", function (card) {
										var player = _status.event.player;
				...
				content: function () {
					...
					if (event.cardname) {
						goon = game.hasPlayer(function (current) {
							return (
								player.canUse(event.cardname, current) &&
								get.effect(current, { name: event.cardname }, player, player) > 0
							);
						});
					}
					player
			...
			ly_piliche: {
				...
				check: function (event, player) {
					return (
						get.attitude(player, event.player) *
							get.value(event.player.getDiscardableCards(player, "e"), event.player) <=
						0
					);
				},
				filter: function (event, player) {
							...
							if (att > 0) {
								if (
									...
									target.countCards("j", function (card) {
										return game.hasPlayer(function (current) {
											return (
												current.canAddJudge(card) && get.attitude(player, current) < 0
											);
										});
									})
								)
			...
			xinxhzhiyan: {
				...
				filter: function (event, player) {
					return (
						(!player.hasSkill("xinxhzhiyan_true") && player.countCards("h") > player.hp) ||
						(!player.hasSkill("xinxhzhiyan_false") && player.countCards("h") < player.maxHp)
					);
				},
				filterCard: true,
				selectCard: function () {
					...
					if (
						ui.selected.cards.length ||
						player.hasSkill("xinxhzhiyan_false") ||
			...
			xinxhzhiyan_false: {
				mod: {
					playerEnabled: function (card, player, target) {
						if (
							player != target &&
							(!get.info(card) || !get.info(card).singleCard || !ui.selected.targets.length)
						)
							return false;
					},
				},
					...
					onunmark: function (storage, player) {
						if (player.storage.weifeng2) {
							game.log(
								player,
								"移去了一个",
								"#g【惧(" + get.translation(player.storage.weifeng2) + ")】",
								"标记"
							);
		...
		dynamicTranslate: {
			...
			spshidi: function (player) {
				if (player.countMark("spshidi") % 2 == 0)
					return '转换技，锁定技。①准备阶段/结束阶段开始时，若你发动此分支的累计次数为奇数/偶数，则你获得一个“☯”。<span class="bluetext">②若你的“☯”数为偶数，则你至其他角色的距离-1，且你使用的黑色【杀】不可被响应。</span>③若你的“☯”数为奇数，则其他角色至你的距离+1，且你不可响应红色【杀】。';
			...
			mobilexingxue: function (player) {
				return lib.translate[
					(player.storage.mobileyanzhu ? "mobilexingxuex" : "mobilexingxue") + "_info"
				];
			},
			shoufa: function (player) {
				...
				if (!zhoufa)
					return (
						...
						nodoudizhu +
						"角色，令其随机执行以下一项：豹，令其受到1点无来源伤害；鹰，你随机获得其一张牌；熊，你随机弃置其装备区的一张牌；兔，令其摸一张牌。"
					);
			...
			mbxuetu(player) {
				...
				if (status === 0) {
					if (!xuetu)
						return '转换技。出牌阶段限一次，<span class="bluetext">阴：你可以弃置一张牌，然后令一名角色回复1点体力；</span>阳：你可以失去1点体力，然后令一名角色摸两张牌。';
					...
					if (!xuetu)
						return '转换技。出牌阶段限一次，<span class="bluetext">阴：你可以回复1点体力，然后令一名角色弃置两张牌；</span>阳：你可以摸一张牌，然后对一名角色造成1点伤害。';
		...
		translate: {
			...
			xinfu_shangjian_info:
				"锁定技。一名角色的结束阶段开始时，若你于此回合内不因使用装备牌而失去了X张或更少的牌，则你摸等量的牌（X为你的体力值）。",
			...
			xinfu_qiaosi: "巧思",
			xinfu_qiaosi_info:
				"出牌阶段限一次，你可以投掷一枚六面骰子，亮出牌堆顶的X张牌并获得之。然后，你选择一项：1.交给一名其他角色X张牌。2.弃置X张牌。（X为骰子的点数）",
			xin_xiahoudun: "手杀界夏侯惇",
			xin_xiahoudun_prefix: "手杀界",
			xinqingjian: "清俭",
			xinqingjian2: "清俭",
			xinqingjian_info:
				"每回合限一次。当你不因摸牌阶段的额定摸牌而得到牌后，你可以将任意张牌扣置于武将牌上。回合结束时，你将这些牌交给一名其他角色。若这些牌的数量大于1，你摸一张牌。",
			zhangyì: "张翼",
			jiakui: "贾逵",
			zhiyi: "执义",
			zhiyi_info:
			...
			rezhiyi: "执义",
			rezhiyi_info:
				"锁定技，一名角色的结束阶段开始时，若你本回合内使用或打出过基本牌，则你选择一项：1.摸一张牌。2.视为使用一张你本回合内使用或打出过的基本牌。",
			zhongzuo: "忠佐",
			zhongzuo_info:
				"一名角色的结束阶段开始时，若你于此回合内造成或受到过伤害，则你可以令一名角色摸两张牌。若该角色已受伤，则你摸一张牌。",
			wanlan: "挽澜",
			wanlan_info:
				"限定技，当一名角色进入濒死状态时，你可以弃置所有手牌（无牌可不弃）。其回复体力至1点，然后你对当前回合角色造成1点伤害。",
			re_jikang: "手杀嵇康",
			re_jikang_prefix: "手杀",
			shenpei: "审配",
			re_wangyun: "手杀王允",
			...
			qiaosi: "巧思",
			qiaosi_info:
				"出牌阶段限一次，你可以表演「大键角色图」并根据表演结果获得相应的牌。然后，你选择一项：1.弃置X张牌。2.将X张牌交给一名其他角色。（X为你以此法得到的牌数）",
			qiaosi_map: "大键角色图",
			qiaosi_map_info:
			...
			zhouxuan2: "周旋",
			zhouxuan_info:
				"出牌阶段限一次，你可以弃置一张牌并指定一名角色，然后选择一个基本牌的名称或非基本牌的类型。其使用或打出下一张牌时，若此牌的名称或类型和你选择的相同，则你观看牌堆顶的三张牌，然后将这些牌以任意分割方式交给任意名角色。",
			fengji: "丰积",
			fengji_info:
			...
			xinwanlan: "挽澜",
			xinwanlan_info:
				"当一名角色受到伤害值不小于体力值的伤害时，你可以弃置装备区中的所有牌（至少一张） 防止此伤害。",
			re_xusheng: "手杀界徐盛",
			...
			rejiuchi: "酒池",
			rejiuchi_info:
				"你可以将一张黑桃手牌当做【酒】使用。当你于回合内使用带有【酒】效果的【杀】造成伤害时，你令你的〖崩坏〗失效直到回合结束。",
			furong: "手杀傅肜",
			furong_prefix: "手杀",
			xuewei: "血卫",
			xuewei_info:
			...
			daoji: "盗戟",
			daoji_info:
				"出牌阶段限一次，你可以弃置一张非基本牌并选择一名装备区里有牌的其他角色，你获得其装备区中的一张牌并使用之。若你以此法得到的牌是武器牌，则你使用此牌后对其造成1点伤害。",
			xin_hansui: "手杀韩遂",
			...
			liyong3: "厉勇",
			liyong_info:
				"锁定技，若你于出牌阶段内使用的【杀】被【闪】抵消，则你获得如下效果：你本回合使用的下一张【杀】不可被响应且伤害+1，指定的目标本回合非锁定技失效，当此【杀】造成伤害后，若目标角色未死亡，你失去1点体力。",
			gongsunkang: "公孙康",
			juliao: "据辽",
			...
			tianshu: "天书",
			tianshu_info:
				"出牌阶段开始时，若场上没有【太平要术】，则你可以弃置一张牌并选择一名角色。该角色获得并使用【太平要术】。",
			re_jiangwei: "手杀界姜维",
			...
			jueyong: "绝勇",
			jueyong_info:
				"锁定技。①当你不因〖绝勇〗成为唯一牌的目标时，若此牌不为转化牌且对应的实体牌牌数为1且不为【桃】或【酒】且你的“绝”数小于你的体力值，则你将此牌置于你的武将牌上，称为“绝”，且取消此牌的目标。②结束阶段开始时，若你有“绝”，则你令所有“绝”的原使用者依次对你使用所有“绝”，将无法使用的“绝”置入弃牌堆。",
			poxiang: "破降",
			poxiang_info:
			...
			chongxu_faq: "目前的曲库",
			chongxu_faq_info:
				"　<br>《鸟之诗》- 折户伸治<br>《竹取飛翔　～ Lunatic Princess》- ZUN<br>《ignotus》- ak+q<br>《Super Mario 3D World Theme》- 横田真人<br>《只因你太美》- SWIN-S<br>《Croatian Rhapsody》- Maksim<br>《罗刹海市》- 刀郎<br>《Pigstep (Stereo Mix)》- Lena Raine",
			miaojian: "妙剑",
			miaojian_info:
				"出牌阶段限一次。你可将一张【杀】当做刺【杀】使用，或将一张锦囊牌当做【无中生有】使用。",
			miaojian1: "妙剑·改",
			...
			bingqing: "秉清",
			bingqing_info:
				"当你于出牌阶段内使用的牌结算结束后，若你于本阶段内使用的所有已结算结束的其他牌与此牌花色均不相同，则你可根据X的值执行对应效果：为2，你令一名角色摸两张牌；为3，你弃置一名角色区域内的一张牌；为4，你对一名其他角色造成1点伤害。（X为你本阶段内使用过的已结算结束的牌中包含的花色数）",
			yingfeng: "迎奉",
			yingfeng_info:
			...
			mobileyanzhu: "宴诛",
			mobileyanzhu_info:
				"出牌阶段限一次，你可以令一名有牌的其他角色选择一项：①你获得其装备区里所有的牌，然后你失去技能〖宴诛〗并修改技能〖兴学〗。②你获得其区域里的一张牌。",
			mobilexingxue: "兴学",
			mobilexingxue_info:
				"结束阶段开始时，你可以令至多X名角色依次摸一张牌并将一张牌置于牌堆顶（X为你的体力值）。",
			mobilexingxuex: "兴学·改",
			mobilexingxuex_info:
				"结束阶段开始时，你可以令至多X名角色依次摸一张牌并将一张牌置于牌堆顶或交给一名其他目标角色（X为你的体力上限）。",
			re_wuguotai: "手杀界吴国太",
			...
			xingtu2: "约数",
			xingtu_info:
				"锁定技。你使用点数为X的倍数的牌无次数限制，你使用点数为X的约数的牌时摸一张牌（X为你本局游戏使用的上一张牌的点数）。",
			juezhi: "爵制",
			juezhi_info:
				"出牌阶段，你可以弃置至少两张牌，然后从牌堆中获得一张点数为Y的牌（Y为这些牌的点数和对13取余，余数为0时Y取13）。",
			sp_jianggan: "手杀蒋干",
			sp_jianggan_prefix: "手杀",
			spdaoshu: "盗书",
			spdaoshu_info:
				"每轮限一次。一名敌方角色的出牌阶段开始时，若其有手牌，则你可以令其视为使用一张【酒】。其须声明一个基本牌的牌名，然后你判断其手牌区内是否有该牌名的牌。若你判断正确，则你获得其两张手牌。",
			spdaoshu_info_identity:
				"每轮限一次。一名其他角色的出牌阶段开始时，若其有手牌，则你可以令其视为使用一张【酒】。其须声明一个基本牌的牌名，然后你判断其手牌区内是否有该牌名的牌。若你判断正确，则你获得其两张手牌。",
			spdaoshu_info_guozhan:
				"每轮限一次。一名其他角色的出牌阶段开始时，若其有手牌，则你可以令其视为使用一张【酒】。其须声明一个基本牌的牌名，然后你判断其手牌区内是否有该牌名的牌。若你判断正确，则你获得其两张手牌。",
			mbdaoshu: "盗书",
			mbdaoshu_info:
				"出牌阶段限一次，你可以选择一名手牌数大于两张的其他角色，其随机获得三个牌名并将一张手牌的牌名伪装成其中一个与原牌名不同的牌名，然后你和队友观看其手牌并猜测其伪装的手牌，猜对的角色对其造成1点伤害，猜错的角色随机弃置两张手牌（手牌数不足两张则改为失去1点体力）。",
			mbdaoshu_info_identity:
				"出牌阶段限一次，你可以选择一名手牌数大于两张的其他角色，其随机获得三个牌名并将一张手牌的牌名伪装成其中一个与原牌名不同的牌名，然后你观看其手牌并猜测其伪装的手牌。若猜中，你对其造成1点伤害；若猜错，你随机弃置两张手牌（手牌数不足两张则改为失去1点体力）。",
			mbdaoshu_info_guozhan:
				"出牌阶段限一次，你可以选择一名手牌数大于两张的其他角色，其随机获得三个牌名并将一张手牌的牌名伪装成其中一个与原牌名不同的牌名，然后你观看其手牌并猜测其伪装的手牌。若猜中，你对其造成1点伤害；若猜错，你随机弃置两张手牌（手牌数不足两张则改为失去1点体力）。",
			spdaizui: "戴罪",
			spdaizui2: "戴罪",
			spdaizui_info:
			...
			sbyaoming: "邀名",
			sbyaoming_info:
				"蓄力技（2/4）。①当你受到1点伤害后，你可以获得1点蓄力值。②出牌阶段或当你受到伤害后，你可消耗1点蓄力值并选择一项：⒈弃置一名手牌数不小于你的角色的一张牌。⒉令一名手牌数不大于你的角色摸一张牌。若你上次发动〖邀名②〗时未获得过蓄力值且你选择的选项和上次不同，则你获得1点蓄力值。",
			ruanhui: "阮慧",
			mingcha: "明察",
			mingcha_info:
				"摸牌阶段开始时，你亮出牌堆顶的三张牌。若这三张牌中有点数小于9的牌，则你可以放弃摸牌并获得这些牌，然后你可以获得一名其他角色的随机一张牌。",
			jingzhong: "敬重",
			jingzhong_info:
			...
			buxu_backup: "补叙",
			buxu_info:
				"出牌阶段，若你的“六经”中有空缺的位置，则你可以弃置X+1张牌并选择一种空缺的“六经”（X为你本阶段内发动过〖补叙〗的次数）。系统从牌堆或弃牌堆中检索一张对应的牌，然后你将此牌置于你武将牌上，填补“六经”的对应位置。",
			re_dianwei: "手杀界典韦",
			...
			yijin: "亿金",
			yijin_info:
				"锁定技。①游戏开始时，你获得“膴仕”、“金迷”、“贾凶”、“通神”、“拥蔽”、“厚任”各1枚（均称为“金”）。②出牌阶段开始时，你选择一名没有“金”的其他角色。你交给其1枚“金”，且令其获得对应效果。③一名角色的回合结束后，若其有你交给其的“金”，其移去此“金”。④当你死亡时，移去场上所有你交出的“金”。⑤回合开始时，若你没有“金”，你死亡。",
			yijin_wushi: "膴仕",
			...
			jiebing: "借兵",
			jiebing_info:
				"锁定技。当你受到伤害后，你选择来源外的一名其他角色，随机获得其一张牌并展示。若此牌为装备牌，你使用之。",
			hannan: "扞难",
			...
			sbbenxi: "奔袭",
			sbbenxi_info:
				"出牌阶段开始时，你可以弃置至少一张牌，然后你于此阶段获得如下效果：①你至其他角色距离-X；②当你使用的下一张基本牌或普通锦囊牌A选择目标后，你可以额外指定X名距离为1的角色为目标；③牌A结算结束后，若此牌造成过伤害，你摸五张牌（X为你以此法弃置的牌数）。",
			xin_zhuzhi: "手杀界朱治",
			xin_zhuzhi_prefix: "手杀界",
			sbanguo: "安国",
			sbanguo_info:
				"①游戏开始时，你令一名其他角色获得1枚“安国”标记（有“安国”的角色手牌上限基数等于体力上限）。②出牌阶段开始时，你可以将一名有“安国”的角色的所有“安国”移动给一名本局游戏未获得过“安国”的其他角色。③当你受到伤害时，若有有“安国”的角色且伤害值不小于你的体力值且此伤害没有来源或来源没有“安国”，防止此伤害。④一名角色进入濒死状态时，若其有你因〖安国①〗获得的“安国”，你移去其该“安国”，令其将体力回复至1点。然后你选择一项：1.若你的体力值大于1，你失去体力至1点；2.若你的体力上限大于1，你将体力上限减至1。最后你令其获得1点护甲。",
			wangjun: "手杀王濬",
			wangjun_prefix: "手杀",
			zhujian: "筑舰",
			...
			duansuo: "断索",
			duansuo_info:
				"出牌阶段限一次。你可以重置任意名处于连环状态的角色，然后对这些角色各造成1点火焰伤害。",
			sp_pengyang: "手杀彭羕",
			sp_pengyang_prefix: "手杀",
			spdaming: "达命",
			spdaming_info:
				"①游戏开始时，你获得1点“达命”值。②其他角色A的出牌阶段限一次。其可以交给你一张牌，然后你选择另一名其他角色B。若B有与此牌相同类型的牌，其将一张该类型的牌交给A，你获得1点“达命”值；否则你将此牌交给A。",
			spxiaoni: "嚣逆",
			spxiaoni_info:
				"①出牌阶段限一次。若你的“达命”值大于0，你可以将一张牌当任意一种【杀】或伤害类锦囊牌使用。然后你减少等同于此牌指定目标数的“达命”值。②你的手牌上限基数为X（X为“达命”值，且至多为你的体力值，至少为0）。",
			xin_zhuhuan: "手杀界朱桓",
			xin_zhuhuan_prefix: "手杀界",
			xinpingkou: "平寇",
			xinpingkou_info:
				"回合结束时，你可以对至多X名其他角色各造成1点伤害（X为你本回合跳过的阶段数）。然后你从牌堆中获得一张装备牌。",
			xin_caoxiu: "手杀界曹休",
			xin_caoxiu_prefix: "手杀界",
			xinqingxi: "倾袭",
			xinqingxi_info:
				"每回合限一次。当你对其他角色造成伤害时，你可以令其选择一项：1.弃置X张手牌（X为4减去你至其的距离，至少为1）；2.令此伤害+1。",
			yj_weiyan: "☆魏延",
			yj_weiyan_prefix: "☆",
			mbguli: "孤厉",
			mbguli_info:
				"出牌阶段限一次。你可以将所有手牌当做一张无视防具的【杀】使用。此牌结算结束后，若此牌造成过伤害，你可以失去1点体力并将手牌摸至X张（X为你的体力上限）。",
			mbaosi: "骜肆",
			mbaosi_info:
				"锁定技。当你于出牌阶段对一名攻击范围内的角色造成伤害后，你于此阶段对其使用牌无次数限制。",
			xin_zhoutai: "手杀界周泰",
			...
			qianzhao_prefix: "手杀",
			mbshihe: "势吓",
			mbshihe_info_identity:
				"出牌阶段限一次。你可以与一名角色拼点。若你：赢，当其于其下回合结束前对你造成伤害时，取消之；没赢，你随机弃置一张牌。",
			mbshihe_info:
				"出牌阶段限一次。你可以与一名角色拼点。若你：赢，当其于其下回合结束前对你和你的友方角色造成伤害时，取消之；没赢，你随机弃置一张牌。",
			mbzhenfu: "镇抚",
			mbzhenfu_info: "结束阶段，若你本回合因弃置失去过牌，你可以令一名其他角色获得1点护甲。",
			shichangshi: "十常侍",
			mbdanggu: "党锢",
			mbdanggu_info:
				"锁定技。①游戏开始时，你获得十张“常侍”牌，然后你进行一次结党。②当你修整结束后，你进行一次结党并摸一张牌。③若你有亮出的“常侍”牌，你视为拥有这些牌的技能。",
			mbdanggu_faq: "关于结党",
			mbdanggu_faq_info:
				"<br>系统随机选择一张未亮出过的“常侍”牌，然后选择四张未亮出过的“常侍”牌。你观看前者，然后从后者中选择一名认可前者的“常侍”牌。然后若此时不为双将模式，你将这两张武将牌作为你的武将牌（不移除原有技能）；否则你获得这两张武将牌上的技能。",
			mbdanggu_faq2: "关于认可",
			mbdanggu_faq2_info:
				"<br>双向不认可常侍为固定组合：<br><li>郭胜、段珪<br><li>韩悝、毕岚<br>单向不认可常侍为系统随机分配。<br>每次结党至多存在一张不认可主将的常侍牌，且若此次结党仅有一张常侍牌，则不会存在不认可情况。",
			mbmowang: "殁亡",
			mbmowang_info:
				"锁定技。①当你死亡前，若你有未亮出的“常侍”牌且体力上限大于0，你将死亡改为修整至你的下个回合开始前，然后你复原武将牌，且不于此次死亡事件中进行展示身份牌、检测游戏胜利条件与执行奖惩的流程。②回合结束后，你死亡。",
			mbmowang_faq: "关于修整",
			...
			scschiyan: "鸱咽",
			scschiyan_info:
				"①当你使用【杀】指定目标后，你可以将其的一张牌置于其武将牌上，然后其于当前回合结束时获得这些牌。②当你因执行【杀】的效果对一名角色造成伤害时，若该角色的手牌数和装备区内的牌数均不大于你，此伤害+1。",
			scs_sunzhang: "孙璋",
			scszimou: "自谋",
			scszimou_info:
				"锁定技。出牌阶段，当你使用第二/四/六张牌时，你从牌堆中获得一张【酒】/【杀】/【决斗】。",
			scs_bilan: "毕岚",
			scspicai: "庀材",
			scspicai_info:
				"出牌阶段限一次。你可进行判定牌不置入弃牌堆的判定。若判定结果与本次发动技能时的其他判定结果的花色均不相同，则你可以重复此流程。然后你将所有位于处理区的判定牌交给一名角色。",
			scs_xiayun: "夏恽",
			scsyaozhuo: "谣诼",
			scsyaozhuo_info:
				"出牌阶段限一次。你可以与一名角色拼点，若你赢，其跳过下一个摸牌阶段；若你没赢，你弃置两张牌。",
			scs_hankui: "韩悝",
			scsxiaolu: "宵赂",
			scsxiaolu_info:
			...
			scskuiji: "窥机",
			scskuiji_info:
				"出牌阶段限一次。你可以观看一名其他角色的手牌，然后弃置你与其的共计四张花色各不相同的手牌。",
			scs_duangui: "段珪",
			scschihe: "叱吓",
			scschihe_info:
				"当你使用【杀】指定唯一目标后，你可亮出牌堆顶的两张牌，令此【杀】的伤害值基数+X（X为亮出牌中花色与此【杀】相同的牌数），且目标角色不能使用亮出牌包含的花色的牌响应此【杀】。",
			scs_guosheng: "郭胜",
			scsniqu: "逆取",
			...
			scsanruo: "安弱",
			scsanruo_info:
				"你可以将一张♥牌当【桃】、♦牌当火【杀】、♣牌当【闪】、♠牌当【无懈可击】使用。当你以此法使用或打出【杀】或【闪】时，你可以获得对方的一张牌；当你以此法使用【桃】时，你可以获得一名其他角色的一张牌；当你以此法使用【无懈可击】时，你可以获得此牌响应的普通锦囊牌的使用者的一张牌。",
			scsmiaoyu: "妙语",
			scsmiaoyu_info:
				"你可以将至多两张相同花色的牌按照以下规则使用或打出：♦牌当作火【杀】，♥牌当作【桃】，♣牌当作【闪】，♠牌当作【无懈可击】。若你以此法使用了两张红色牌，则此牌回复值或伤害值+1。若你以此法使用了两张黑色牌，则你弃置当前回合角色一张牌。",
			re_xiaoqiao: "手杀界小乔",
			...
			xinkuizhu: "溃诛",
			xinkuizhu_info:
				"弃牌阶段结束后，你可以选择一项：1.令至多X名角色各摸一张牌。2.对任意名体力值之和为X的角色造成1点伤害，若你以此法选择的角色数不小于2，你失去1点体力。（X为你此阶段弃置的牌数）",
			xinzhizheng: "掣政",
			xinzhizheng_info:
				"锁定技，你的出牌阶段内，攻击范围内不包含你的其他角色不能成为你使用牌的目标。出牌阶段结束时，若你本阶段内使用的牌数小于这些角色的数量，则你弃置其中一名角色的一张牌。",
			xinlijun: "立军",
			xinlijun_info:
				"主公技，其他吴势力角色于其回合内使用【杀】结算完毕后，其可以将此【杀】对应的实体牌交给你，然后你可以令其摸一张牌。",
			xin_zhangyi: "手杀界张嶷",
			xin_zhangyi_prefix: "手杀界",
			xinwurong: "怃戎",
			xinwurong_info:
				"出牌阶段限一次，你可以与一名其他角色进行谋弈：<br><li>若你选择“镇压”且其选择“反抗”，你对其造成1点伤害，然后你摸一张牌。<br><li>若你选择“安抚”且其选择“归顺”，其须交给你两张牌（若其牌数不足两张，则改为令其跳过其下个摸牌阶段）。<br><li>若你选择“镇压”且其选择“归顺”，你获得其一张牌，然后你交给其两张牌。<br><li>若你选择“安抚”且其选择“反抗”，你受到1点伤害，然后你摸两张牌。",
			xin_guozhao: "手杀郭照",
			xin_guozhao_prefix: "手杀",
			yichong: "易宠",
			yichong_info:
				"①准备阶段，你可以选择一名其他角色并选择一个花色，然后你获得其所有此花色的装备牌和其一张此花色的手牌，移除场上的所有“雀”标记，令其获得“雀”标记直到你的下个回合开始。②拥有“雀”标记的角色获得你最后一次发动〖易宠①〗选择的花色的牌后，你获得这些牌（你至多通过每个“雀”得到一张牌）。",
			wufei: "诬诽",
			wufei_info:
				"若场上存在拥有“雀”标记的角色A，则：①当你使用【杀】或伤害类锦囊牌指定第一个目标后，你令A成为此牌伤害来源。②当你受到伤害后，若A的体力值大于3，则你可以令A受到1点无来源伤害。",
			yj_zhoubuyi: "☆周不疑",
			yj_zhoubuyi_prefix: "☆",
			mbhuiyao: "慧夭",
			mbhuiyao_info:
				"出牌阶段限一次。你可以受到1点无来源伤害，然后你选择一名其他角色，令其视为对另一名角色造成过1点伤害。",
			mbquesong: "雀颂",
			mbquesong_info:
				"一名角色的结束阶段，若你于本回合受到过伤害，你可以令一名角色选择一项：1.摸X张牌并复原武将牌（X为3，若其装备区非宝物牌牌数不小于三张则X为2）；2.回复1点体力。",
			xin_yuanshao: "手杀界袁绍",
			...
			yimou: "毅谋",
			yimou_info:
				"当一名角色受到伤害后，若其存活且你至其的距离不大于1，你可以选择一项：1.令其从牌堆中获得一张【杀】；2.令其将一张手牌交给另一名角色，然后摸一张牌。",
			jiangji: "手杀蒋济",
			jiangji_prefix: "手杀",
			jilun: "机论",
			jilun_info:
				"①当你受到伤害后，若你拥有技能〖急筹〗，则你可以一项：1.摸两张牌。2.获得1枚“机论”标记。②一名角色的结束阶段，若你拥有“机论”，则重复选择执行以下项直到你没有“机论”标记：1.失去1枚“机论”标记，视为使用一张〖急筹①〗记录过且未被〖机论②〗记录过的普通锦囊牌并记录此牌牌名。2.失去所有“机论”标记。",
			liwei: "李遗",
			jiaohua: "教化",
			jiaohua_backup: "教化",
			jiaohua_info:
				"出牌阶段限两次，你可以选择一个未被〖教化〗记录过的牌的类型，令一名角色从牌堆中获得一张此类型的牌，然后记录此类型，若基本、锦囊、装备均已被你发动〖教化〗记录，则你清空〖教化〗记录。",
			laimin: "来敏",
			laishou: "来寿",
			laishou_info:
				"锁定技。①当你受到伤害值大于等于你的体力值的伤害时，若你的体力上限小于9，你防止此伤害并增加等量体力上限。②准备阶段，若你的体力上限不小于9，你死亡。",
			luanqun: "乱群",
			luanqun_info:
				"出牌阶段限一次，若你有手牌，则你可以令所有有手牌的角色同时展示一张手牌，然后你可以获得其中一张与你展示的牌颜色相同的展示牌，所有本次展示牌颜色与你展示的牌颜色不同的角色的下个出牌阶段使用的第一张【杀】只能对你使用，且此【杀】不可被响应。",
			xin_wuban: "吴班",
			xinjintao: "进讨",
			xinjintao_info:
				"锁定技，你使用【杀】无距离限制且次数上限+1。你于出牌阶段内使用的第一张【杀】不可被响应，第二张【杀】伤害+1。",
			xinlianhuan: "连环",
			xinlianhuan_info:
				"你可以将一张♣手牌当【铁索连环】使用或重铸。你使用【铁索连环】选择目标后，可以给此牌增加一个目标。",
			mb_sunluyu: "手杀孙鲁育",
			...
			mbmeibu: "魅步",
			mbmeibu_info:
				"其他角色的出牌阶段开始时，若你在其攻击范围内，你可以弃置一张牌，令该角色于本回合内获得〖止息〗。若你以此法弃置的牌不是【杀】或黑色锦囊牌，则本回合其与你的距离视为1。",
			mbzhixi: "止息",
			mbzhixi_info:
				"锁定技。出牌阶段，若你于此阶段使用过的牌数不小于X，你不能使用牌（X为你的体力值）；当你使用锦囊牌时，你结束此阶段。",
			yanxiang: "阎象",
			kujian: "苦谏",
			kujian_info:
				"出牌阶段限一次，你可以将至多两张手牌称为“谏”并交给一名其他角色，然后你获得以下效果：当其他角色使用或打出牌后，若其中有“谏”，你与其各摸两张牌；当其他角色不因使用或打出而失去牌后，若其中有“谏”，你与其各弃置一张牌。",
			mb_xianglang: "手杀向朗",
			mb_xianglang_prefix: "手杀",
			naxue: "纳学",
			naxue_info:
				"你可以跳过出牌阶段。若如此做，你可以弃置任意张牌并摸等量的牌，然后你可以交给至多两名其他角色各一张手牌。",
			yijie: "遗诫",
			yijie_info:
				"锁定技。当你死亡时，你令所有其他角色将体力回复或失去至X（X为所有其他角色的体力之和除以所有其他角色数，向下取整，且X至少为1）。",
			mb_chengui: "手杀陈珪",
			mb_chengui_prefix: "手杀",
			guimou: "诡谋",
			guimou_info:
				"锁定技。游戏开始时/回合结束时，你随机/须选择以下一项直到你的下个准备阶段：①记录场上期间角色使用牌数；②记录期间场上角色弃置牌数；③记录期间场上角色获得牌数。准备阶段，你可以选择一名场上对应记录数值最少的其他角色，观看其手牌并选择其中一张牌，然后你将此牌交给另一名其他角色或弃置此牌。",
			zhouxian: "州贤",
			zhouxian_info:
				"锁定技。当你成为其他角色使用的伤害类卡牌的目标后，你亮出牌堆顶的三张牌，然后其须选择一项：①弃置一张与亮出牌之一类别相同的牌；②令此牌对你无效。",
			mb_huban: "手杀胡班",
			mb_huban_prefix: "手杀",
			mbyilie: "义烈",
			mbyilie2: "义烈",
			...
			zhoulin: "咒鳞",
			zhoulin_info:
				"限定技，出牌阶段，你可以获得2点护甲值，然后选择一个“兽法”效果，你发动〖兽法〗的执行效果改为你选择的效果直到你的下个回合结束。",
			xin_huojun: "手杀霍峻",
			xin_huojun_prefix: "手杀",
			sidai: "伺怠",
			sidai_info:
				"限定技，出牌阶段，你可以将手牌区内的所有基本牌当做【杀】使用。若此牌对应的实体牌中：包含【闪】，则目标角色成为此牌的目标后，需弃置一张基本牌，否则不可响应此牌；包含【桃】，则当目标角色受到此牌的伤害后，其减1点体力上限。",
			jieyu: "竭御",
			jieyu_info:
				"结束阶段，你可以从弃牌堆中获得共X张不同牌名的基本牌（X为4-你上次发动〖竭御〗至今你成为其他角色使用伤害类卡牌目标的次数，且X至少为1）。",
			jieyu_info_identity:
				"结束阶段，你可以从弃牌堆中获得共X张不同牌名的基本牌（X为3-你上次发动〖竭御〗至今你成为其他角色使用伤害类卡牌目标的次数，且X至少为1）。",
			yangfeng: "杨奉",
			mbxuetu: "血途",
			mbxuetu_info:
				"转换技。出牌阶段限一次，阴：你可以弃置一张牌，然后令一名角色回复1点体力；阳：你可以失去1点体力，然后令一名角色摸两张牌。",
			mbxuetu_achieve: "血途·成功",
			mbxuetu_achieve_info:
				"出牌阶段各限一次。⒈你可以弃置一张牌，然后令一名角色回复1点体力；⒉你可以失去1点体力，然后令一名角色摸两张牌。",
			mbxuetu_fail: "血途·失败",
			mbxuetu_fail_info:
				"转换技。出牌阶段限一次，阴：你可以回复1点体力，然后令一名角色弃置两张牌；阳：你可以摸一张牌，然后对一名角色造成1点伤害。",
			mbweiming: "威命",
			mbweiming_info:
				"使命技，锁定技。①出牌阶段开始时，你记录一名未以此法记录过的角色。②成功：当你杀死一名未被〖威命①〗记录过的角色后，修改〖血途〗为成功版本。③失败：当一名被〖威命①〗记录过的角色死亡后，你修改〖血途〗为失败版本。",
			lizhaojiaobo: "李昭焦伯",
			mbzuoyou: "佐佑",
			mbzuoyou_info:
			...
			mbkuangli: "狂戾",
			mbkuangli_info:
				"锁定技。①出牌阶段开始时，你随机令场上任意名其他角色获得“狂戾”标记。②出牌阶段限两次。当你使用牌指定有“狂戾”的角色为目标后，你与其各随机弃置一张牌，然后你摸一张牌。③回合结束时，你移除所有角色的“狂戾”。",
			mbxiongsi: "凶肆",
			mbxiongsi_info:
				"限定技。出牌阶段，若你的手牌数不少于三张，你可以弃置所有手牌，然后令所有其他角色依次失去1点体力。",
			mb_sp_guanqiujian: "SP毌丘俭",
			mb_sp_guanqiujian_prefix: "SP",
			mbcuizhen: "摧阵",
			mbcuizhen_info_identity:
				"①游戏开始时，你可以废除至多两名其他角色的武器栏。②当你于出牌阶段使用伤害类牌指定其他角色为目标后，若目标角色的手牌数不小于体力值，你可以废除其武器栏。③摸牌阶段，你令额定摸牌数+X（X为所有角色被废除的武器栏数之和，至多为2）。",
			mbcuizhen_info:
				"①当你于出牌阶段使用伤害类牌指定其他角色为目标后，若目标角色的手牌数不小于体力值，你可以废除其武器栏。②摸牌阶段，你令额定摸牌数+X（X为所有角色被废除的武器栏数之和，至多为2）。",
			mbkuili: "溃离",
			mbkuili_info:
				"锁定技。当你受到伤害后，你弃置等同于伤害值的手牌；若来源有被废除的武器栏，你令其恢复武器栏。",
			mb_caomao: "手杀曹髦",
			mb_caomao_prefix: "手杀",
			mbqianlong: "潜龙",
			mbqianlong_info:
				"①游戏开始时，你获得20枚“道心”标记。②当你得到牌后/受到1点伤害后/造成1点伤害后，你获得5/10/15枚“道心”（上限为100枚）。③若你的“道心”数不小于25/50/75/100，你视为拥有〖清正〗/〖酒诗〗/〖放逐〗/〖决进〗。",
			mbcmqingzheng: "清正",
			mbcmqingzheng_info:
				"出牌阶段开始时，你可以弃置两种花色的所有手牌，并观看一名有手牌的其他角色的手牌，你弃置其中一种花色的所有牌。若其被弃置的牌数小于你以此法弃置的牌数，你对其造成1点伤害。",
			mbcmjiushi: "酒诗",
			mbcmjiushi_info:
				"①当你需要使用【酒】时，若你的武将牌正面向上，你可以翻面，视为使用一张【酒】。②当你受到伤害后，若你的武将牌背面向上，你可以翻面。③当你翻面后，你获得牌堆里的一张锦囊牌。",
			mbcmfangzhu: "放逐",
			mbcmfangzhu_info:
				"出牌阶段限一次。你可以选择一名其他角色，选择一项：⒈令其不能使用手牌中的非锦囊牌直到其回合结束；⒉令其所有非Charlotte技能失效直到其回合结束。",
			mbjuejin: "决进",
			mbjuejin_info:
				"限定技。出牌阶段，你可以令所有角色依次将体力回复或失去至1并获得X点护甲（X为一名角色以此法变化的体力值）。然后你增加如下“向死存魏”的全局技能：当有牌进入弃牌堆后，系统将这些牌中的【闪】、【桃】和【酒】移出游戏。",
			mbweitong: "卫统",

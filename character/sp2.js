      ...
      //十周年管宁
          ...
          var skills=[];
					...
					// else if(_status.connectMode) list=get.charactersOL();
						...
						// 	list.push(i);
						// }
            skills=['tianyi', 'nzry_yili', 'zhichi', 'reyicong', 'new_yijue', 'rerende', 'rejizhi', 'renxin', 'zhiyu', 'juyi', 'relixia', 'dcchongyi', 'tongli', 'renzheng', 'cslilu', 'reyixiang', 'xinfu_qianxin', 'yishe']
					}
					// for(var i of list){

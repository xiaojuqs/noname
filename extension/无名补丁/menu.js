...
window.nmimport(function(lib, game, ui, get, ai, _status){	
	ui.create.menu = function (connectMenu) {
		...
		var openMenu = function(node, e, onclose) {
			...
			/*game.playAudio('../extension/无名补丁/audio/Menu.mp3');
			/*这里也是第一次点击选项的声音*/
			popupContainer.onclose = onclose;
		};
		var clickToggle = function() {
		game.playAudio('../extension/无名补丁/audio/MidButton.mp3');
		/*关闭选项的声音*/
		...
		var clickSwitcher = function() {
			...
			game.playAudio('../extension/无名补丁/audio/WinButton.mp3');
			/*内部选项第一下点击的声音*/
			if (this._link.menu) {
		...
		var clickMenuItem = function() {
			...
			game.playAudio('../extension/无名补丁/audio/TinyButton.mp3');
			/*内部选项，比如斗地主选模式等*/
			if (config.onclick) {
	...
	var head = ui.create.div('#closemenu1',menuContainer);

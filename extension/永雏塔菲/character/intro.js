const characterIntro = {
	...
	hoshino: "阿拜多斯高等学校的前副会长，现在是担任对策委员会的委员长的慵懒少女。拥有大叔似的说话口气，比起工作更喜欢玩耍。虽然因为偷懒会常常被委员会的伙伴说教，可一旦执行任务，就会为了守护伙伴而奋斗在最前线。",
	swimsuit_hoshino: "阿拜多斯高等学校所属，为了追求悠闲度过夏日而来到无人岛的对策委员会的委员长。与表面上怕麻烦的态度相反，做准备的时候却很认真。但是，似乎本人没有意识到自己比平常稍微积极的样子。",
	himari: "千年科学学园所属，黑客集团「真理部」的原部长，现在是特异现象搜查部的部长。自称超天才病弱美少女黑客，好像是千年史上的仅有3人获得了的「全知」学位的所有者……这是真实的吗，这个学位真的存在吗，这都被一层神秘的面纱所笼罩着。日鞠说，少女正因有着很多秘密才美丽……诸如此类的话。另外，作为实力首屈一指指的天才黑客的同时，她也是一位对一切神秘的事物有着浓厚兴趣的少女。",
	limulu: "来自异世界的弱小史莱姆",
};
